...
const IslandShapeSvg = () => (
  <svg class={styles.islandSvg} viewBox="0 0 1 1" preserveAspectRatio="none" aria-hidden="true">
    <path
      d={ISLAND_CLIP_PATH}
      fill={ISLAND_BG}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onMouseLeave={props.trigger !== "click" && props.trigger !== "focus" ? hide : undefined}
      >
        <Show when={isIsland()} fallback={<div class={styles.content}>{props.title}</div>}>
