  ...
  return (
    <div style={sectionStyle}>
      ...
      <div style={labelStyle}>
        动森风格婚礼请柬，定位为「设计 → 导出图片 → 分享 / 打印」。组件本身只渲染卡面，导出按钮通过
        ref 在外部触发。
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ display: "grid", "grid-template-columns": "1fr 1fr", gap: "8px" }}>
            <Field label="新娘">
              <Input value={brideName()} onInput={(e) => setBrideName(e.target.value)} />
            </Field>
            <Field label="新郎">
              <Input value={groomName()} onInput={(e) => setGroomName(e.target.value)} />
            </Field>
          </div>
          ...
          <div style={{ display: "grid", "grid-template-columns": "1fr 1fr 1fr", gap: "8px" }}>
            ...
            <Field label="星期">
              <Input value={weekday()} onInput={(e) => setWeekday(e.target.value)} />
            </Field>
            <Field label="时间">
          ...
          <Show when={showLotteryNumber()}>
            <>
              <div style={{ display: "grid", "grid-template-columns": "1fr 1fr", gap: "8px" }}>
                ...
                <Field label="抽奖区标题">
                  <Input value={lotteryLabel()} onInput={(e) => setLotteryLabel(e.target.value)} />
                </Field>
              </div>
              <Field label="抽奖区说明">
                <Input value={lotteryHint()} onInput={(e) => setLotteryHint(e.target.value)} />
              </Field>
            </>
          </Show>
